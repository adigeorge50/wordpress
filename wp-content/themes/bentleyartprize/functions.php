	...
	function twentyten_setup() {
		...
		register_nav_menus(
			array(
				...
				'footer_menu_1' => __( 'Footer Menu 1', 'twentyten' ),
				'footer_menu_2' => __( 'Footer Menu 2', 'twentyten' ),
			)
		);
...
function twentyten_scripts_styles() {
	...
	// wp_enqueue_style( 'twentyten-block-tyle', get_template_directory_uri() . '/blocks.css', array(), '20181018' );

	wp_enqueue_script( 'slick', get_template_directory_uri() . '/includes/slick/slick.min.js', array ( 'jquery' ), 1.0, true);
